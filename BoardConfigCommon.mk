...
TARGET_GLOBAL_CPPFLAGS += -O3 -mtune=cortex-a15 -mcpu=cortex-a15 -mfpu=neon-vfpv4 -mfloat-abi=softfp

TARGET_GLOBAL_CLANG_FLAGS += -Ofast -mtune=krait2 -mcpu=krait2 -mfpu=neon-vfpv4 -mfloat-abi=softfp
